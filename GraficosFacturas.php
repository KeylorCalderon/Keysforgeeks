                ...
                <?php
                    if (isset($_POST['fechaFin'])) {
                        ...
                        if($fechaFin<$fechaInicio){
                            ...
                            echo "<form class='formulario' method='post' action='verFacturasDetalle.php?fechaInicio=$fechaInicioAux&fechaFin=$fechaFin&tipo=$tipoBusqueda' name='verDetalle' id='verDetalle'>
